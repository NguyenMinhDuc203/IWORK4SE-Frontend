...
export default function SavedJobsPage() {
  ...
  const { refreshSavedJobs, toggleSaveJob } = useSavedJobs()
      ...
      <div className="container mx-auto px-4 py-8">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button
                      ...
                      onClick={(e) => {
                        e.preventDefault()
                        e.stopPropagation()
                        handleUnsaveJob(job.id, job.jobPostId)
                      }}
                    >
        ...
        {!isLoading && sortedJobs.length === 0 && (
          <div className="text-center py-12">
            <p className="text-gray-600 mb-4">Bạn chưa lưu công việc nào</p>
            <Link href="/jobs">
